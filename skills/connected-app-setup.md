...
```
execute("openssl req -x509 -sha256 -nodes -days 365 -newkey rsa:2048 -keyout server.key -out server.crt -subj '/CN=HarnessforceConnectedApp'")
```
...
```
write_file("force-app/main/default/certs/Harnessforce_Cert.crt", <contents of server.crt>)
```
...
```
write_file("force-app/main/default/permissionsets/Harnessforce_API_Access.permissionset-meta.xml", `
<?xml version="1.0" encoding="UTF-8"?>
<PermissionSet xmlns="http://soap.sforce.com/2006/04/metadata">
    <label>Harnessforce API Access</label>
    <description>Grants access to the Harnessforce Connected App</description>
...
execute("sf org assign permset --name Harnessforce_API_Access --target-org {alias}")
```
